...
tar -cf "$OUT_DIR/snapshots-$TAG.tar" -C "$BUILD_WORKSPACE_DIRECTORY" go.mod go.sum docker snapshots BUILD.bazel MODULE.bazel WORKSPACE WORKSPACE.bzlmod README.md LICENSE
