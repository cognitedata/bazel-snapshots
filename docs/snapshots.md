...
<pre>
load("@com_cognitedata_bazel_snapshots//snapshots/private:snapshots.bzl", "change_tracker")
...
<pre>
load("@com_cognitedata_bazel_snapshots//snapshots/private:snapshots.bzl", "create_tracker_file")
...
<pre>
load("@com_cognitedata_bazel_snapshots//snapshots/private:snapshots.bzl", "snapshots")
